...
#include "Vfrontend_tsp_tb_top.h"
#include "Vfrontend_tsp_tb_top___024root.h"
#include "verilated.h"
#include <cstdio>
#include <cstdint>
#include <cstdlib>
...
static Vfrontend_tsp_tb_top* dut;
#define VRAM dut->rootp->frontend_tsp_tb_top__DOT__vram
#define FB   dut->rootp->frontend_tsp_tb_top__DOT__fb
...
int main(int argc,char**argv){
    ...
    snprintf(out_path, sizeof(out_path), "shaded_%s.bmp",name);
    printf("dump set: %s (%s, %s)\n", name, regs_path, vram_path);

    dut=new Vfrontend_tsp_tb_top;
