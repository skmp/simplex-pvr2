//
// stage_i2 - per-stage timing harness for tsp_shade_pp.
...
//
module stage_i2 import tsp_pkg::*; (
    input             clk,
    input             reset,
    input             wr_en,
    input      [12:0] wr_addr,
    ...
    fp_add3_24_pp a (.clk(clk),.reset(reset),.stall(in_reg[34][0]),.in_valid(in_reg[34][1]),
