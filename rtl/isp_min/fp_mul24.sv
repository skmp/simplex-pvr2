...
// ISP/TSP setup datapath. Identical rules to fp_mul16 but with the FULL float32
// mantissa instead of the truncated 16-bit one:
...
//     exponent to 0xFE (max finite), underflow flushes to signed zero.
//
// Drop-in replacement for fp_mul16 (same ports); trades a DSP for accuracy. The
// C++ model fp_mul<24,24> in tools/fpm.h is bit-equivalent to this.
//
